...
- [ ] When using the Clarifai SDK configure it in a less heavy processing enviromnent. Another solution may be to run it on a seperate thread but on a lower priority thread. Consider using the .background thread
  - [ ] Check out https://medium.com/modernnerd-code/grand-central-dispatch-crash-course-for-swift-3-8bf2652c1cb8 for dispatch queues.
  -[ ] Another resource for async function calls https://github.com/duemunk/Async
